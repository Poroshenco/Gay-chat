...
namespace GayChat.Extensions
{
    public static class StringExtentions
    {
        private static readonly Regex __MobileCheck = new Regex(
        ...
        private static readonly Regex __MobileVersionCheck = new Regex(
        ...
        {
            var u = request.GetUserAgent();

            if (u.Length < 4)
                return false;

            return __MobileCheck.IsMatch(u) || __MobileVersionCheck.IsMatch(u.Substring(0, 4));
        }
